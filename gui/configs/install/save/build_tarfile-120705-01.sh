...
#echo ""
#vno=`cat configs/install/version_number.txt`
#echo -n "Found version number $vno; "; 
#latest_p4=(`p4 changes | head -1`)
#latest_p4=${latest_p4[1]}
#echo    "latest p4 says $latest_p4"
#echo; echo -n "Does that look right (^C to exit)? "; read ans
...
echo "Then:"
echo "    ssh neva"
echo '    $CHIPGEN/gui/configs/install/build_release.sh |& tee /tmp/$$'
#echo "    echo \$cnum > $CHIPGEN/gui/configs/install/version_number.txt"
#echo '    cd $CHIPGEN/gui/configs/install/latest-release'
#echo '    set cnum = `cat ../version_number.txt`; echo $cnum'
#echo "    cp gui.tar.bz2 gui--r\$cnum.tar.bz2"
#echo "    set cnum=(Change number 'ddddd' of submit)"
...
#echo ""
#echo -n "Found version number "; cat version_number.txt
#echo    "Latest p4 says $latest_p4"
#echo -n "Does that look right? "; read ans
