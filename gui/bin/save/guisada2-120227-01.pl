...
# If URL = "http://hostname:8081/hello", print a hello message.
...
# print "howdy.  (handler) = ".$handler."\n\n";
# print "howdy.  ref(handler) = ".ref($handler)."\n\n";

#  | sed 's|src=.*alt=.tree.|src="images/stanford_seal.gif" alt="tree"|'
#  | sed 's|src=.*alt=.tree.|src|'
...
#    if ($path =~ /gif$/) {
##        print `cat images/stanford_seal.gif`;
#        print `cat .$path`;
#        return(0);
#    }
#
...
#         $cgi->h2("qs $qs");
#
#    print "okay now i'm here: ".`pwd`."<br>\n\n";
