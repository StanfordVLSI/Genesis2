...
<script type="text/javascript"><!--
  ...
  var DBG=0;
  var CURRENT_DESIGN_FILENAME = "../designs/FloatingPointGen/FPGen.js";
  if (DBG) { alert("Current design = " + CURRENT_DESIGN_FILENAME); }

  var NEW_DESIGN_BASENAME = "mydesign";
  if (DBG) { alert("New design = " + NEW_DESIGN_BASENAME); }

  var CURRENT_BOOKMARK = "top";
  if (DBG) { alert("Current place = " + CURRENT_BOOKMARK); }

  var CGI_URL = "/cgi-bin/genesis";                       // E.g. "/cgi-bin/genesis"
  if (DBG) { alert("URL for cgi dir = " + CGI_URL); }

  var HOME_URL = "/genesis";                      // E.g. "/genesis"
  if (DBG) { alert("URL for gui = " + HOME_URL); }

//--></script>

<?php
$filename = "../designs/FloatingPointGen/FPGen.js";

if (file_exists($filename)) {
} else {
   echo "<h1>ERROR: cannot find '<tt>designs/FloatingPointGen/FPGen.js</tt>'.<br>";
   echo "Do you know how to fix this?  If not ... ask Steve!</h1>";
   echo "Hint: See 0notes/fpgen.txt and/or...<br>";
   echo " &nbsp; &nbsp; <tt>% cd vlsiweb:/var/www/homepage/genesis</tt><br>";
   echo " &nbsp; &nbsp; <tt>% cd designs/FloatingPointGen</tt><br>";
   echo " &nbsp; &nbsp; <tt>% cp empty.js FPGen.js</tt><br><br>";
...
?>
  ...
  <?php include "../designs/FloatingPointGen/FPGen.js";              ?>  <!-- Chip config data structures -->
...
<!-- optional CMP demo instructions        -->
  ...
  <div id="CVL" style="display:none">http://www-vlsi.stanford.edu/cgi-bin/genesis/opendesign.pl?newdesign=tmp&amp;file=../designs/FloatingPointGen/FPGen.xml&amp;modpath=top</div>
...
<div id="help" style="display:none; font-size:small">
  ...
  <p>Current design base is <b>../designs/FloatingPointGen/FPGen.js</b>
  <br>Design name going forward is <b>mydesign</b>
