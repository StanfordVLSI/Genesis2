...
#            do_pass = [-1,0,0,0,0,0]
            ...
            if re.search("1", sys.argv[1]) : print_pass[1] = 1; print tmpmsg % 1;
            if re.search("2", sys.argv[1]) : print_pass[2] = 1; print tmpmsg % 2;
            if re.search("3", sys.argv[1]) : print_pass[3] = 1; print tmpmsg % 3;
            if re.search("4", sys.argv[1]) : print_pass[4] = 1; print tmpmsg % 4;
            if re.search("5", sys.argv[1]) : print_pass[5] = 1; print tmpmsg % 5;
            if re.search("6", sys.argv[1]) : print_pass[6] = 1; print tmpmsg % 6;
            print ""

#            print_pass = do_pass # E.g. [0,1,1,0]

#            do_pass = [-1,1,1,1,1,1] # Always do all passes.
