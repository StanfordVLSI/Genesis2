...
do './utils.pl'; #  includes get_system_dependences()
...
sub getparms {
    ...
    # Remaining parms are xml parameters for xml "PARMLIST" e.g.
    #
    #     $PARMLIST{NUM_MEM_MATS} = 1
    #     $PARMLIST{SPECIAL}{3} = bar3      # array: SPECIAL[3] = bar3
    #     $PARMLIST{SPECIAL{0}{name} = baz  # array of hashes
	...
	if($pair=~m/([^=]+)=(.*)/) {
	    ...
	    $pairnum++;
	    if ($pairnum > 4) {
#		set_PARMLIST_val_old($field, $value);
		set_PARMLIST_val($field, $value);
	    }
	}
    }
}

sub set_PARMLIST_val_old {
    my $field = shift @_;
    my $value = shift @_;
    $PARMLIST{$field} = $value;
}
...
sub set_PARMLIST_val {
    ...
    if ($npe == 0) {                                            # E.g. PARMLIST{p1} = v1
	                  $PARMLIST{$pe[0]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]} = $value\n"; }
    }
    elsif ($npe == 1) {                                     # E.g. PARMLIST{SPECIAL}{3} = bar3
	                  $PARMLIST{$pe[0]}{$pe[1]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]} = $value\n"; }
    }
    elsif ($npe == 2) {                             # E.g. PARMLIST{SPECIAL}{2}{name} = SYNCLOAD
	                  $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]} = $value\n"; }
    }
    elsif ($npe == 3) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]} = $value\n"; }
    }
    elsif ($npe == 4) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]} = $value\n"; }
    }
    elsif ($npe == 5) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]} = $value\n"; }
    }
    elsif ($npe == 6) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]} = $value\n"; }
    }
    elsif ($npe == 7) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]} = $value\n"; }
    }
    elsif ($npe == 8) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]}{$pe[8]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]}{$pe[8]} = $value\n"; }
    }
    elsif ($npe == 9) {   $PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]}{$pe[8]}{$pe[9]} = $value;
	if ($DBG) { print "PARMLIST{$pe[0]}{$pe[1]}{$pe[2]}{$pe[3]}{$pe[4]}{$pe[5]}{$pe[6]}{$pe[7]}{$pe[8]}{$pe[9]} = $value\n"; }
    }
    else {
	print "ERROR: Really? More than nine path elements?  Really??\n";
    }
#    print "\n";
}
