...
sub btb_tablerow {
    my $href = shift @_; # E.g. "http://vlsiweb/genesis/designs/tgt0/foo.tar"
    my $text = shift @_; # E.g. "Download foo.tar"
    my $comm = shift @_; # E.g. "<= Click to download tar file..."

    my $rval = "";

    $rval .= "  <tr>\n";
    $rval .= "    <td align=right><a href=$href>$text</a></td>\n";
    $rval .= "    <td align=left >$comm</td>\n";
    $rval .= "  </tr>\n";
...
#print  btb_tablerow("link1", "hey foo foo", "hey what");
#print  btb_tablerow("link2", "foo", "bar");

print btb_tablerow("$design_url/$designdir/$basename.tar",
                   "Download $basename.tar",
                   "<= Click to download a tar file including xml file");

print btb_tablerow("$cleancmd",
                   "Delete $basename.tar",
                   "<= Click to download a tar file including xml file ".
                   "and all generated *.v files."
                   );


#print "  <tr>\n";
#print "    <td align=right>hey foo foo foo</td>\n";
#print "    <td align=left>hey what</td>\n";
#print "  </tr>\n";
#print "  <tr>\n";
#print "    <td align=right>foo</td>\n";
#print "    <td align=left>bar</td>\n";
#print "  </tr>\n";
