...
my $testtype = $ARGV[1];  # "old" (works) or "new" (broken)
print "Running *$testtype* test.\n";

if ($testmode) {
    $ENV{QUERY_STRING} = "newdesign=udtest"                  # ("Updatedesign test")
#      ."&curdesign=updatedesign.dir%2Ftest%2Ftgt0-baseline2.js"
      ."&curdesign=updatedesign.dir%2Ftest%2Ftmp-tb2.js"
...
my ($clones,$deletes) = getparms(\%INPUT, \%PARMLIST);
