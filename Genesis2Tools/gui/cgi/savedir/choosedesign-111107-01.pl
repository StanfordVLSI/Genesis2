...
#         '  .popuptable { display:none; position:absolute;top:10px;right:10px; z-index:1;',
         '  .popuptable { display:none; position:absolute; z-index:1; width:100%; ',
#         '                border:1px solid #c3c3c3;background-color:#e5eecc; font-size:small; }',
...
#	    print "    <input  style='position:absolute' type='radio' name='file' value='$fullpath'$selected "."/><tt>$design</tt><br />\n";
	    ...
	    print "    <div  style='position:relative; padding:0px 20px'>\n";
            print "      <button type=button id=button$id onclick='do_nothing($id)'>\n";
            print "        <tt>$design</tt>\n";
            print "      </button>\n";
            print "      <br />\n";
            print_buttons($id);
