...
my $designs  = `ls -1 ../designs/tgt0/tgt0-baseline.xml`                                . "newline\n";
   $designs .= `ls -1 ../designs/tgt0/*.xml | grep -v 'designs/tgt0/tgt0-baseline.xml'` . "newline\n";
   $designs .= `ls -1 ../designs/*.xml`                                                  . "newline\n";
   $designs .= `ls -1 ../designs/*/*.xml | grep -v 'designs/tgt0/'`;
