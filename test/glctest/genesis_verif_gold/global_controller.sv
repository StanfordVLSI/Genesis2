...
//	
//
//  Source file: /nobackup/steveri/github/Genesis2/test/glctest/global_controller/rtl/genesis/global_controller.svp
...
//
// num_glb_tiles (_GENESIS2_CMD_LINE_PRIORITY_) = 2
//
// cgra_width (_GENESIS2_CMD_LINE_PRIORITY_) = 4
//
// cgra_width_including_io (_GENESIS2_CMD_LINE_PRIORITY_) = 4
//
...
module global_controller (
    ...
    output logic [1:0]         glb_pcfg_broadcast_stall, 
    output logic [$clog2(2)*1-1:0] glb_flush_crossbar_sel,
...
logic [1:0]         jtag_glb_clk_en_master, axi_glb_clk_en_master;
logic [1:0]         jtag_glb_clk_en_bank_master, axi_glb_clk_en_bank_master;
...
logic [17:0]       jtag_sram_cfg_wr_addr;
