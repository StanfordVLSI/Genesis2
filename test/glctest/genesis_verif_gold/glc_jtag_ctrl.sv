...
//	
//
//  Source file: /nobackup/steveri/github/Genesis2/test/glctest/global_controller/rtl/genesis/glc_jtag_ctrl.svp
...
//
// glb_addr_width (_GENESIS2_INHERITANCE_PRIORITY_) = 18
//
// num_glb_tiles (_GENESIS2_INHERITANCE_PRIORITY_) = 2
//
// cgra_width (_GENESIS2_INHERITANCE_PRIORITY_) = 4
//
...
module glc_jtag_ctrl (
    ...
    output logic [1:0]         jtag_glb_clk_en_master, 
    ...
    output logic [17:0]        jtag_sram_cfg_wr_addr,
...
logic clk;
logic clk_domain;
logic [31:0] stall, stall_bak;
logic [1:0] glb_pcfg_broadcast_stall;
logic [1:0] glb_clk_en_master;
...
logic                               glb_sram_read;
logic [17:0]       glb_sram_config_addr_out;
...
logic [$clog2(12):0] glb_cfg_wr_clk_en_cnt;
    ...
    if (reset_in==1) begin
        ...
        if (state==ready) begin
            ...
            write_glb_clk_en_master: begin
                glb_clk_en_master <= config_data_jtag_out[1:0];
                read <= 0;
                write <= 0;
                glb_write <= 0;
                glb_read <= 0;
            ...
            write_glb_clk_en_bank_master: begin
                glb_clk_en_bank_master <= config_data_jtag_out[1:0];
                read <= 0;
                write <= 0;
                glb_write <= 0;
                glb_read <= 0;
